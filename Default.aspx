...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-4" style=" background: #eee; box-shadow: 0 8px 8px -4px lightgrey;padding-bottom:78px;margin-top:5px;">
       ...
       <img style="margin-top:50px" src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFveZXViAIX3i5Pg726jUVxADCGu-2Qizndw&usqp=CAU" />
            </div>
</asp:Content>
