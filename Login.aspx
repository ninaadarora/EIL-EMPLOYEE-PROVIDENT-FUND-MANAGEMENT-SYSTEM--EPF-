    ...
    <div class="panel-body">
        <div class="form-horizontal" role="form">
                    ...
                    <div class="col-sm-4">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="vg" runat="server" ErrorMessage="ID cannot be blank" ControlToValidate="txtID" ForeColor="Red"></asp:RequiredFieldValidator>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="Lname">Gender</label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 inline">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:TextBox class="form-control" ID="dob" runat="server"></asp:TextBox>
        ...
        <div class="form-group inline">
            <div class="col-sm-offset-2 col-sm-10">
                <asp:Button CssClass="btn btn-success " ID="btnReg" OnClick="btnReg_Click" ValidationGroup="vg" runat="server" Text="Register"></asp:Button>
                    ...
                    <div style="border-color: black">
                        <div style="border-width: 3em">
                            <div style="background-color: aliceblue">
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" class="table table-bordered table-condensed table-responsive table-hover " AllowPaging="true" OnPageIndexChanging="GridView2_PageIndexChanging" PageSize="25">
                                    <Columns>
                                        ...
                                        <asp:BoundField ItemStyle-Width="150px" DataField="Contribution" HeaderText="Contribution" />
                                        <asp:BoundField ItemStyle-Width="150px" DataField="Gross_salary" HeaderText="Gross_salary" />
        ...
        <div class="form-group inline">
            <div class="col-sm-offset-2 col-sm-10">
                <asp:Button CssClass="btn btn-warning " ID="btnexcel" OnClick="btnexcel_Click" runat="server" Text="Export To Excel"></asp:Button>
